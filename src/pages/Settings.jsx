...
// Facilities and QuickBooks are flagged as too technical/risky for an AFH
// owner/manager to configure themselves; Clock-in PINs and team/tablet-login
// management briefly moved to Care Team as a manager self-serve feature, but
// moved back here — the user decided those should be admin-only too.
